//
//  CustomMusicVisualizerView.swift
//  Dynamic-Notch
//
//  Created by PeterPark on 8/24/25.
//
...
// MARK: - SwiftUI Wrapper for AudioSpectrum
...
struct Visualizer: View {
    ...
    var body: some View {
        Rectangle()
            ...
            .mask {
                AudioSpectrumView(isPlaying: .constant(isPlaying))
...
// MARK: - Previews
#Preview("BoringNotch AudioSpectrum") {
    AudioSpectrumView(isPlaying: .constant(true))
        .frame(width: 16, height: 20)
        .background(.black)
}

#Preview("BoringNotch Visualizer - Playing") {
    Visualizer(isPlaying: true)
        .frame(width: 37, height: 23)
        .background(.black)
}

#Preview("BoringNotch Visualizer - Stopped") {
    Visualizer(isPlaying: false)
        .frame(width: 37, height: 23)
        .background(.black)
}

#Preview("LiveActivity with BoringNotch Visualizer") {
    HStack(spacing: 0) {
        // 앨범아트
        Rectangle()
            .fill(.blue)
